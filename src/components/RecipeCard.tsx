      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <div className="pt-4 border-t border-gray-50 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-[#333]">{recipe?.authorName || 'SavoryShare Chef'}</span>
          </div>
          
          <div className="flex items-center gap-1.5 text-gray-400 group-hover:text-[#d48c45] transition-colors">
            <Heart size={14} fill={(recipe?.likesCount || 0) > 0 ? "currentColor" : "none"} className={(recipe?.likesCount || 0) > 0 ? "text-[#d48c45]" : ""} />
